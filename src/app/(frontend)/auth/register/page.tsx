...
import { Eye, EyeOff, Mail, Lock, User, Building, Phone, ArrowRight, MessageSquare, AlertCircle, CheckCircle } from 'lucide-react';
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">Mulai gratis 14 hari, tidak perlu kartu kredit</p>
          </div>
          ...
          {isSuccess ? (
            <div className="text-center py-8">
              ...
              <p className="text-slate-600">Akun Anda telah dibuat. Silakan cek email untuk verifikasi.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="terms" className="ml-2 text-sm text-slate-600">
                  Saya setuju dengan{' '}
                  <Link href="/syarat-ketentuan" className="text-emerald-600 hover:text-emerald-700 font-medium">
                    Syarat & Ketentuan
                  </Link>{' '}
                  dan{' '}
                  <Link href="/kebijakan-privasi" className="text-emerald-600 hover:text-emerald-700 font-medium">
                    Kebijakan Privasi
                  </Link>
                </label>
              </div>
          ...
          {!isSuccess && (
            <button
              ...
              disabled={isLoading}
              className="w-full bg-white border border-slate-200 text-slate-700 py-3 px-4 rounded-lg font-medium hover:bg-slate-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
            >
